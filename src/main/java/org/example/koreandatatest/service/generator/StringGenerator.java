...
import org.example.koreandatatest.DTO.MockDataDto;
...
public class StringGenerator implements MockDataGenerator{
  ...
  public String generate(Integer blankPercent, String typeOptionJson, String forceValue) {
    ...
    String body = mockDataDtos
        .stream().map(MockDataDto::mockDataValue)
...
//    int offset = (difference < 1 ? difference : randomGenerator.nextInt(difference)) + option.minLength();
